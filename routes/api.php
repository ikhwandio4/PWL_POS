...
Route::delete('barangs/{barang}',[BarangController::class,'destroy']);
Route::get('penjualans', [ControllersPenjualanController::class, 'index']);
Route::post('penjualans', [ControllersPenjualanController::class, 'store']);
Route::get('penjualans/{penjualans}', [ControllersPenjualanController::class, 'show']);
Route::put('penjualans/{penjualans}', [ControllersPenjualanController::class, 'update']);
Route::delete('penjualans/{penjualans}', [ControllersPenjualanController::class, 'destroy']);
